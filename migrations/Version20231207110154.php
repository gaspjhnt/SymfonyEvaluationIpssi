 ...
 */
final class Version20231207110154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contenu_panier DROP INDEX UNIQ_80507DC0F347EFB, ADD INDEX IDX_80507DC0F347EFB (produit_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contenu_panier DROP INDEX IDX_80507DC0F347EFB, ADD UNIQUE INDEX UNIQ_80507DC0F347EFB (produit_id)');
